 ...
 * @since       1.0.0
 */
class Xxtea implements ICrypt, \core\adapter\IFactoryAble {
	/**
	 * (non-PHPdoc)
	 * @see \core\adapter\crypt\ICrypt::encrypt()
	 */
	public function encrypt($str, $key) {
		...
		if (!$key || !is_string($key)) {
			throw new Exception('[core\\crypt\\Xxtea::encrypt] security key is required.', 
				Exception::ERROR_PARAMETER_TYPE_ERROR);
		}
	...
	/**
	 * (non-PHPdoc)
	 * @see \core\adapter\crypt\ICrypt::decrypt()
	 */
	public function decrypt($str, $key) {
		...
		if (!$key || !is_string($key)) {
			throw new Exception('security key is required.', 
				Exception::ERROR_PARAMETER_TYPE_ERROR);
		}
